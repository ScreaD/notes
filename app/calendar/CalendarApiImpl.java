...
public class CalendarApiImpl implements CalendarApi {
     ...
     * Application name.
     */
    private static final String APPLICATION_NAME = "Genetic-Scheduller";
    ...
    public static Credential authorize() {
        // Load client secrets.
        InputStream in = CalendarQuickstart.class.getResourceAsStream("/resources/client_secret.json");
